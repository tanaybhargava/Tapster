...
public class BarMenuDB {
		...
		public static final String DATABASE_TABLE = "menu";
		...
		public BarMenuDB(Context ctx) {
			this.context = ctx;
			myDBHelper = new DatabaseHelper(context);
		}
		
		public BarMenuDB open() {
		...
		public Cursor getAllRowsOfCat(String category) {
